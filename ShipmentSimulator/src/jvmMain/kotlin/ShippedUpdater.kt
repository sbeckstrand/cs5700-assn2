class ShippedUpdater(simulator: TrackingSimulator) : UpdateStrategy() {
    ...
    override fun buildUpdate(updateString: String) {
        ...
        try {
            ...
            throw Exception("Invalid update input. Shipped type should have format of: shipped,<id>,<created timestamp>, <estimated delivery timestamp>")
        }
        ...
        if (simulator.findShipment(id) == null) {
            ...
            val update = ShippingUpdate(shipment?.status, "shipped",  estimatedDeliveryTimestamp, null)
